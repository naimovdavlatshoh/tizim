...
const AppHeader: React.FC = () => {
    ...
    useEffect(() => {
        ...
        } else if (path.includes("/my-statistics")) {
            setCurrentPage("my-statistics");
    ...
    return (
        <header className="sticky top-0 z-99999 flex w-full bg-white border-gray-200  dark:border-gray-800 dark:bg-gray-900 lg:border-b">
            <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-6 py-2">
                ...
                <div
                    ...
                    } flex-col sm:flex-row items-stretch sm:items-center justify-between w-full gap-3 sm:gap-4 px-4 sm:px-5 py-4 lg:flex shadow-theme-md lg:justify-end lg:px-0 lg:shadow-none`}
                >
                    {/* Mobile Search */}
                        ...
                        <form>
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    onChange={handleSearchChange}
                                    placeholder="Поиск..."
                                    className="dark:bg-dark-900 h-10 w-full rounded-lg border border-gray-200 bg-transparent py-2 pl-10 pr-3 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-800 dark:bg-white/[0.03] dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800"
                                />
                            </div>
                        </form>
                    </div>
